  ...
  await knex(tableName).insert([
    {
      ...
      box_office_id: 1,
      concert_id: 1,
      box_office_phone_number: "01568 616460", // NULL
      box_office_website_link: "", // i guess there is a more specific link than this though...
      order_no: 1,
    },
    {
