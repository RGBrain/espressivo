...
export const getNextConcertData = async () => {
  ...
  //  GETTING WORKS FOR CONCERT...  a concert does not necessarily have a list of works (e.g. it might just have concert_description instead), although most would have works
