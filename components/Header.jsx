...
export default function Header() {
  ...
  return (
    <div className="flex items-center justify-between py-2 bg-orange p-6">
      <Image className="m-6 shrink-1" src="/esp_logo_white.svg" width={250} height={250} alt="Espressivo Logo" />
      <nav>
        {/* Mobile menu */}
        <section className="flex lg:hidden">
          <div
            //   Hamburger Icon
            className="space-y-2 m-6 max-xs:mr-0"
          ...
          <div className={isNavOpen ? "showMenuNav" : "hideMenuNav"}>
            {/* X close icon */}
            <div className="absolute top-6 right-4 px-8 py-8" onClick={() => setIsNavOpen(false)}>
