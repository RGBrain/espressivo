  ...
  return (
    <div className="flex flex-col md:flex-row justify-center relative md:gap-1">
      <div className="md:grow-2 md:basis-2/3">
        ...
        <div className="border-b-2 border-orange border-opacity-35 mx-20 md:mx-10"></div>
      ...
      <div className="md:grow-1 md:basis-1/3">
        ...
        <div className="border-b-2 border-orange border-opacity-35 mx-20 md:mx-7 md:mr-9"></div>
